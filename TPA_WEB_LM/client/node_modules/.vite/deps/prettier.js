...
var require_standalone = __commonJS({
  "../../../../../node_modules/prettier/standalone.js"(exports, module) {
    (function(t) {
      ...
      var he = (e, t, r) => (r = e != null ? fu(du(e)) : {}, nr(t || !e || !e.__esModule ? $e(r, "default", { value: e, enumerable: true }) : r, e)), ur = (e) => nr($e({}, "__esModule", { value: true }), e);
      var Cu = (e, t, r) => {
        if (!t.has(e))
        ...
        or.prototype = { diff: function(t, r) {
          ...
          function p() {
            for (var F = -1 * a; F <= a; F += 2) {
              ...
              if (!h || B && E.newPos < C.newPos ? (m = yu(C), u.pushComponent(m.components, void 0, true)) : (m = E, m.newPos++, u.pushComponent(m.components, true, void 0)), g = u.extractCommon(m, r, t, F), m.newPos + 1 >= s && g + 1 >= D)
...
${l}`), n ? o.reset(l) : l;
      ...
      var ui = {};
      We(ui, { __debug: () => ni, check: () => ti, doc: () => Qt, format: () => lu, formatWithCursor: () => cu, getSupportInfo: () => ri, util: () => tr, version: () => nu });
      var hu = (e, t, r, n) => {
        if (!(e && t == null))
...
`);
      ...
      var M = "string", j = "array", W = "cursor", S = "indent", T = "align", v = "trim", _ = "group", b = "fill", k = "if-break", P = "indent-if-break", L = "line-suffix", I = "line-suffix-boundary", A = "line", O = "label", x = "break-parent", Ue = /* @__PURE__ */ new Set([W, S, T, v, _, b, k, P, L, I, A, O, x]);
      function ku(e) {
        if (typeof e == "string")
          return M;
        if (Array.isArray(e))
...
Expected it to be ${n}.`;
      ...
      var Cr = { type: I }, le = { type: x }, hr = { type: v }, ke = { type: A, hard: true }, _t = { type: A, hard: true, literal: true }, Ke = { type: A }, gr = { type: A, soft: true }, G = [ke, le], He = [_t, le], be = { type: W };
      function xe(e, t) {
        z(e), ze(t);
        let r = [];
      ...
      function J(e) {
        ...
        return e.type === k ? { ...e, breakContents: J(e.breakContents), flatContents: J(e.flatContents) } : e.type === _ ? { ...e, contents: J(e.contents), expandedStates: (t = e.expandedStates) == null ? void 0 : t.map(J) } : e.type === b ? { type: "fill", parts: e.parts.map(J) } : e.contents ? { ...e, contents: J(e.contents) } : e;
      }
      function Ar(e) {
      ...
      var Or = (e) => {
        if (Array.isArray(e))
          return e;
        if (e.type !== b)
          throw new Error(`Expect doc to be 'array' or '${b}'.`);
        return e.parts;
      };
      function Ne(e, t) {
        if (typeof e == "string")
      ...
      function wr(e) {
        for (e = [...e]; e.length >= 2 && y(false, e, -2).type === A && y(false, e, -1).type === x; )
          e.length -= 2;
        if (e.length > 0) {
...
`, o) : l;
            ...
            case b: {
              ...
              m.splice(0, 2);
              let Q = { ind: f, mode: p, doc: Ge(m) }, rr = m[0];
              Qe({ ind: f, mode: K, doc: [E, C, rr] }, [], F, a.length > 0, r, true) ? i.push(Q, Z, g) : B ? i.push(Q, $, g) : i.push(Q, $, h);
              break;
            }
            case k:
            case P: {
...
` || o === "\r" || o === "\u2028" || o === "\u2029")
      ...
      var Nt = Wu;
      var $r = /* @__PURE__ */ new Set(["tokens", "comments", "parent", "enclosingNode", "precedingNode", "followingNode"]), Uu = (e) => Object.keys(e).filter((t) => !$r.has(t));
      function zu(e) {
        return e ? (t) => e(t, $r) : Uu;
      }
      var H = zu;
      ...
      function St(e, t) {
        var _a;
        ((_a = e.comments) != null ? _a : e.comments = []).push(t), t.printed = false, t.nodeDescription = Gu(e);
      }
      function te(e, t) {
      ...
      function nt(e, t) {
        ...
        if (!n)
          return [];
        let s = ((_a = r == null ? void 0 : r(e, t)) != null ? _a : [...Ot(e, { getVisitorKeys: H(o) })]).flatMap((D) => n(D) ? [D] : nt(D, t));
      ...
      function Ur(e, t) {
        ...
        for (let [p, l] of f.entries()) {
          ...
          let $;
          if (i ? $ = [l] : (F.enclosingNode = E, F.precedingNode = m, F.followingNode = C, $ = [F, g, h, B, Z]), Ku(g, h, f, p))
      ...
      function Mr(e, t) {
        ...
        for (i = r; i > 0; --i) {
          ...
          if ((_a = (D = (s = t.printer).isGap) == null ? void 0 : D.call(s, f, t)) != null ? _a : /^[\s(]*$/.test(f))
            u = t.locStart(a);
          else
            break;
        }
...
in order for it to be formatted.`, cliCategory: "Other" }, tabWidth: { type: "int", category: "Global", default: 2, description: "Number of spaces per indentation level.", range: { start: 0, end: 1 / 0, step: 1 } }, useTabs: { category: "Global", type: "boolean", default: false, description: "Indent with tabs instead of spaces." }, embeddedLanguageFormatting: { category: "Global", type: "choice", default: "auto", description: "Control how Prettier formats quoted code embedded in the file.", choices: [{ value: "auto", description: "Format embedded code if Prettier can automatically identify it." }, { value: "off", description: "Never automatically format embedded code." }] } };
      function ut({ plugins: e = [], showDeprecated: t = false } = {}) {
        let r = e.flatMap((o) => {
          var _a;
          return (_a = o.languages) != null ? _a : [];
        }), n = [];
        for (let o of to(Object.assign({}, ...e.map(({ options: u }) => u), Jr)))
          !t && o.deprecated || (Array.isArray(o.choices) && (t || (o.choices = o.choices.filter((u) => !u.deprecated)), o.name === "parser" && (o.choices = [...o.choices, ...eo(o.choices, r, e)])), o.pluginDefaults = Object.fromEntries(e.filter((u) => {
            var i;
      ...
      function Xr(e, t) {
        ...
        return (_a = e.find(({ filenames: n }) => n == null ? void 0 : n.some((o) => o.toLowerCase() === r))) != null ? _a : e.find(({ extensions: n }) => n == null ? void 0 : n.some((o) => r.endsWith(o)));
      }
      function no(e, t) {
        var _a, _b;
        if (t)
          return (_b = (_a = e.find(({ name: r }) => r.toLowerCase() === t)) != null ? _a : e.find(({ aliases: r }) => r == null ? void 0 : r.includes(t))) != null ? _b : e.find(({ extensions: r }) => r == null ? void 0 : r.includes(`.${t}`));
      }
      function uo(e, t) {
        var _a, _b, _c;
        ...
        }), n = (_c = (_b = (_a = no(r, t.language)) != null ? _a : Xr(r, t.physicalFile)) != null ? _b : Xr(r, t.file)) != null ? _c : (t.physicalFile, void 0);
...
`, 1)[0].length);
      ...
      var oo = ["default", "expected", "validate", "deprecated", "forward", "redirect", "overlap", "preprocess", "postprocess"];
      function io(e, t) {
        let r = new e(t), n = Object.create(r);
        for (let o of oo)
          o in t && (n[o] = so(t[o], r, w.prototype[o].length));
        return n;
      }
      var w = class {
        static create(t) {
      ...
      function Vt(e) {
        if (typeof e == "string")
          return { text: e };
        let { text: t, list: r } = e;
        return Do((t || r) !== void 0, "Unexpected `expected` result, there should be at least one field."), r ? { text: t, list: { title: r.title, values: r.values.map(Vt) } } : { text: t };
      }
      function $t(e, t) {
      ...
      var Ut;
      function co(e, t, { logger: r = false, isCLI: n = false, passThrough: o = false, FlagSchema: u, descriptor: i } = {}) {
        if (n) {
          if (!u)
        ...
        }, D = lo(t, { isCLI: n, FlagSchema: u }), a = new dt(D, { logger: r, unknown: s, descriptor: i }), c = r !== false;
...
` + n, e.codeFrame = n, e;
      ...
      async function In(e, t, r, n, o) {
        ...
        let a = H((_a = i.getVisitorKeys) != null ? _a : D), c = [];
        p();
        let d = e.stack;
      ...
      function Yn(e, t, r, n, o) {
        ...
        return (D = i.hasPrettierIgnore) != null && D.call(i, e) ? s = Rn(e, t) : o.has(u) ? s = o.get(u) : s = i.print(e, t, r, n), u === t.cursorNode && (s = Ze(s, (a) => [be, a, be])), i.printComment && (!i.willPrintOwnComments || !i.willPrintOwnComments(e, t)) && (s = Kr(e, s, t)), s;
      }
      async function qt(e, t) {
        var _a, _b;
        let r = (_a = e.comments) != null ? _a : [];
        t[Symbol.for("comments")] = r, t[Symbol.for("tokens")] = (_b = e.tokens) != null ? _b : [], t[Symbol.for("printedComments")] = /* @__PURE__ */ new Set(), Ur(e, t);
      ...
      function wo(e, t) {
        ...
        if (!r)
          return e;
        let o = H(n), u = (_a = r.ignoredProperties) != null ? _a : /* @__PURE__ */ new Set();
        return i(e);
        function i(s, D) {
      ...
      var Wn = /* @__PURE__ */ new Set(["JsonRoot", "ObjectExpression", "ArrayExpression", "StringLiteral", "NumericLiteral", "BooleanLiteral", "NullLiteral", "UnaryExpression", "TemplateLiteral"]), vo = /* @__PURE__ */ new Set(["OperationDefinition", "FragmentDefinition", "VariableDefinition", "TypeExtensionDefinition", "ObjectTypeDefinition", "FieldDefinition", "DirectiveDefinition", "EnumTypeDefinition", "EnumValueDefinition", "InputValueDefinition", "InputObjectTypeDefinition", "SchemaDefinition", "OperationTypeDefinition", "InterfaceTypeDefinition", "UnionTypeDefinition", "ScalarTypeDefinition"]);
      function Mn(e, t, r) {
        if (!t)
          return false;
        switch (e.parser) {
      ...
      function Un(e, t, r) {
        ...
        if (Oo(t)) {
          ...
          ({ startNode: d, endNode: f } = So(a, c, t));
...
`)
      ...
      function ae(e, t = 1) {
        return async (...r) => {
          var _a, _b;
          let n = (_a = r[t]) != null ? _a : {}, o = (_b = n.plugins) != null ? _b : [];
      ...
      var ri = ae(ut, 0), ni = { parse: ae(Zn), formatAST: ae(Qn), formatDoc: ae(eu), printToDoc: ae(tu), printDocToString: ae(ru) };
      return ur(ui);
    });
  }
});
